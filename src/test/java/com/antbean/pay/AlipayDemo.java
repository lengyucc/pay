	...
	public static void main(String[] args) {
		...
		TradeStatusProcessor processor = new TradeStatusProcessor() {
			...
			public long onTradeSuccess(String outTradeNo) {
				...
				alipay.createRefund(new RefundModel(outTradeNo, "123456789213123123", "0.02"),
		...
		AppPayModel _model = new AppPayModel(outTradeNo, "0.02", "测试商品");

		String orderString = alipay.createAppPayTrade(_model, processor, 30000);
